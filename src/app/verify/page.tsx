    ...
    <div className="min-h-screen bg-[#141414] flex flex-col">
      ...
      <div className="relative z-10 px-4 py-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-white font-semibold text-base">WatchDB</span>
        </div>
      </div>
          ...
          {step === "idle" && (
            ...
            >
              <div className="text-center mb-6">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-[#e50914]/10 rounded-full mb-4">
              ...
              <button
                onClick={startVerify}
                className="w-full flex items-center justify-center gap-2 bg-[#e50914] hover:bg-[#f40612] text-white font-bold py-3 px-6 rounded-md transition-all"
              >
                <Play className="w-5 h-5 fill-current" />
                <span className="text-base">Verify & Watch</span>
              </button>
