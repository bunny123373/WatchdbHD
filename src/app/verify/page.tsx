        ...
        <AnimatePresence mode="wait">
          {step === "idle" && (
            ...
            >
              ...
              <button
                onClick={startVerify}
                className="flex items-center gap-2 bg-[#e50914] hover:bg-[#f40612] text-white font-bold py-2.5 sm:py-3 px-4 rounded-md transition-all text-sm"
              >
                <Play className="w-4 h-4 fill-current" />
                <span>Verify & Watch</span>
              </button>

              <div className="mt-3 flex items-center gap-2 text-gray-500 text-[10px] sm:text-xs">
