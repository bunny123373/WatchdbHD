      ...
      <form onSubmit={handleSubmit} className="p-3 sm:p-4 lg:p-6 space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            onChange={handleChange}
            rows={3}
            className="w-full px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg bg-white/5 border border-white/10 text-white focus:outline-none focus:border-[#e50914] resize-none text-sm"
        ...
        <div className="flex gap-2 sm:gap-4 pt-4 border-t border-white/10 mt-4">
