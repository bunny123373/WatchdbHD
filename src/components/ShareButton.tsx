...
export default function ShareButton({ title, url, description }: ShareButtonProps) {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      {isOpen && (
        <div className="absolute top-full left-0 mt-2 p-3 bg-[#1F232D] rounded-lg shadow-xl z-[100] min-w-[240px] border border-[#2a2f3d]">
          <div className="grid grid-cols-4 gap-2 mb-3">
            <button
              onClick={(e) => handleLinkClick(e, shareLinks.facebook)}
            ...
            <button
              onClick={(e) => handleLinkClick(e, shareLinks.telegram)}
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <button
              onClick={(e) => handleLinkClick(e, shareLinks.email)}
