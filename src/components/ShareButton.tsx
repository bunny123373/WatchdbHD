...
export default function ShareButton({ title, url, description }: ShareButtonProps) {
  ...
  return (
    <div className="relative">
      ...
      {showShareMenu && (
        <div className="absolute top-full left-0 mt-2 p-3 bg-[#1F232D] rounded-lg shadow-xl z-50 min-w-[200px] border border-[#2a2f3d]">
          <div className="grid grid-cols-4 gap-2 mb-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center w-10 h-10 bg-[#0A66C2] hover:bg-[#0958a8] rounded-lg transition-colors"
            >
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 w-full py-2 bg-[#2a2f3d] hover:bg-[#353b4a] rounded-lg transition-colors text-white"
          >
            {copied ? (
              <>
