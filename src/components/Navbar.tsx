...
import { Search, Bell, Menu, X, Film, Tv, Home, Loader2 } from "lucide-react";
  ...
  return (
    <nav
      className={cn(
        ...
        isScrolled || isSearchActive ? "bg-[#141414] border-b border-white/5" : "bg-gradient-to-b from-black/90 to-transparent"
      )}
    >
