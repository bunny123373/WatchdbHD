        ...
        <div className="px-4 md:px-6 lg:px-8">
          ...
          {largerGap ? (
            <div className="relative group">
              ...
              <div
                ref={scrollRef}
                className="flex gap-16 sm:gap-20 md:gap-24 overflow-x-auto pb-8 scrollbar-hide scroll-smooth px-2"
          ...
          <div className="relative group">
            ...
            <div
              ref={scrollRef}
              className={`flex overflow-x-auto pb-8 scrollbar-hide scroll-smooth px-2 ${largerGap ? 'gap-4' : 'gap-1.5 md:gap-2 lg:gap-3'}`}
              style={{ scrollbarWidth: "none", msOverflowStyle: "none", WebkitOverflowScrolling: "touch" }}
            >
              <style jsx>{`
                div::-webkit-scrollbar {
