...
function TMDBSearch({ type, onSelect }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TMDBSearch.useEffect": ()=>{
            const searchTMDB = {
                "TMDBSearch.useEffect.searchTMDB": async ()=>{
                    if (query.length < 2) {
                        setResults([]);
                        return;
                    }
            ...
            }["TMDBSearch.useEffect.searchTMDB"];
...
_s(TMDBSearch, "x2QnwbewoxI6LL7dqjF5yT5PJK0=");
_c = TMDBSearch;
var _c;
...
_s(UploadMovieForm, "xU6+1+3qJHhI7grH+jatC6l0EXM=");
_c = UploadMovieForm;
var _c;
...
_s(UploadSeriesForm, "2R3/cSTNRODw+dOOG7Ctcd8EH00=");
_c = UploadSeriesForm;
var _c;
